              ...
              {groupOrder.items.length === 0 ? (
                ...
                <ul className="divide-y divide-slate-100">
                  {groupOrder.items.map((item) => (
                    <li key={item.id} className="px-5 py-4 flex items-start justify-between hover:bg-slate-50 transition-colors group">
                      <div className="flex-1 min-w-0 pr-4">
                        ...
                        {item.notes && (
                          <p className="mt-2 px-3 py-2 bg-slate-50 rounded-lg border border-slate-200 text-sm text-slate-700">
